                                ...
                                <div class="page-title-box">
									<div class="col-lg-10 col-md-12 col-sm-12">
										<div class="">
                                            ...
                                            <h5> <a href="orders"> <i class="mdi mdi-chevron-left-circle-outline"> </i> Back </a></h5>
										</div>
									</div><!-- end col-->
                                             ...
                                             ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <button class="btn btn-outline-dark waves-effect waves-light"  data-bs-toggle="modal" data-bs-target="#complete<?= $i->id;?>"> Process Return   </button>                       
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                            <div class="row">
                                                                                    <div class="col-lg-12">
                                                                                    <form method="POST" action="<?= base_url("accounting/process-returned");?>" class="process_order">
                                                                                        Are you sure to return <b> <?= $i->product_name;?> - <?= $i->total_return;?> </b>  to warehouse ?   
                                                                            ...
                                                                            <div class="row">
                                                                                    ...
                                                                                    <form method="POST" action="<?= base_url("logistics/process-delivery-return");?>" class="process_order">
                                                                                     ...
                                                                                     <div class="mb-3">
                                                                                        ...
                                                                                        <input type="text" name="total_return" class="form-control"   oninput="checkMaxValue(this,<?= $i->quantity;?>)"  required>
                                                                                    </div>
