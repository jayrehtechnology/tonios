                    ...
                    <div class="modal-body">
                                       <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <form action="<?= base_url("accounting/process-expenses");?>" method="POST"  enctype="multipart/form-data" class="process_expenses">
                                                    <input type="hidden" name="csrf_token" id="csrf_token_1" value="<?php echo $this->security->get_csrf_hash(); ?>">
                                                    ...
                                                    <div class="mb-3">
                                                            ...
                                                            <select type="text" name="category" class="form-control" required>
                                                                ...
                                                                <option> BIR , Permit , Licensing Docs & Tax </option>
                                                                <option> Honoraruim </option>
                                                                <option> Employees Loan </option>
                                                                <option> Employees Benefits </option>
                                                                ...
                                                                <option> Untilities </option>
                                                                <option> Furniture & Fixture </option>
                                                                <option> Vehicle Repair & Maintenance </option>
                                                                <option> Building Repair & Maintenance </option>
                                                                <option> Marketing </option>
                                                                <option> Event / Ocassion</option>
