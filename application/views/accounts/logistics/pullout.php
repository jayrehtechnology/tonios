                                                   ...
                                                   <td class="text-center">  <a href="order-details?transaction=<?= $i->trans_code;?>&customer=<?= $i->customer_name;?>"><b> <?= $i->trans_code;?> </b></a></td>
                                                    ...
                                                    <td class="text-center">
                                                       ...
                                                       <?php if($this->session->userdata['logged_in']['department'] == 'Accounting'){?> 
                                                        ...
                                                        <?php } else { 
                                                            echo "<b>  Endorsed to Warehouse </b>";
                                                        }
                                                        ?>
                                                        <?php } ?>
                                                    </td>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                            <div class="row">
                                                                                    <div class="col-lg-12">
                                                                                        <form method="POST" action="<?= base_url("accounting/process-endorse-warehouse");?>" class="process_endorse">
                                                                                        Are you sure to endorse this to warehoouse <b><?= $i->trans_code;?></b>?   
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-outline-warning waves-effect waves-light"  data-bs-dismiss="modal">Close</button>
                                                                <button type="submit" class="btn btn-outline-dark waves-effect waves-light btn_endorse" id="">Yes</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                       <div class="row">
                                            ...
                                            <form action="<?= base_url("customers/process-pullout-order");?>" method="POST"  enctype="multipart/form-data" id="process_order">
                                                    <input type="hidden" name="csrf_token" id="csrf_token_1" value="<?php echo $this->security->get_csrf_hash(); ?>">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".process_endorse").submit(function() {
                $(".btn_endorse").prop("disabled", true).text("Processing...");
            });
