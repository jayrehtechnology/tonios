...
<div class="content-page">
                                    ...
                                    <div class="card-body">
                                           ...
                                           <div id="datatable-buttons_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer"><div class="row">
                                            ...
                                            foreach($orders as $i){ 
                                                ...
                                                ?>
                                                <tr>
                                                   <td class="text-center">  <a href="order-list?transaction=<?= $i->trans_code;?>&customer=<?= $i->customer_name;?>&status=pending"><b> <?= $i->trans_code;?> </b></a></td>
                                                    ...
                                                    <td class="text-center">
                                                        <button class="btn btn-outline-danger waves-effect waves-light"  data-bs-toggle="modal" data-bs-target="#approved<?= $i->id;?>"> Approve Orders </button>                       
                                                    </td>
                                                </tr>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                            <div class="row">
                                                                                    <div class="col-lg-12">
                                                                                    <form method="POST" action="<?= base_url("orders/process-approved");?>" class="process_approved" >
                                                                                    Are you sure to Approve this Order <b><?= $i->trans_code;?></b>?   
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="submit" class="btn btn-outline-dark waves-effect waves-light btn_approved"" >Yes</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
   ...
   <script>
        $(document).ready(function() {
            $(".process_approved").submit(function() {
                $(".btn_approved").prop("disabled", true).text("Processing...");
            });
        });
    </script>
