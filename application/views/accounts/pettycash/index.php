                         ...
                         <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <?php if( $this->session->userdata['logged_in']['position'] == 'Manager'){} else {?> 

                                    <div class="col-lg-2 col-md-3 col-sm-3">
                                      <button class="btn btn-outline-dark waves-effect waves-light"   style="width:100%"   data-bs-toggle="modal" data-bs-target="#staticBackdrop">Request Petty Cash  </button>                       
                                    </div>
                            ...
                            <?php if ($this->session->flashdata('success')): ?>
                                ...
                                <div class="card">
                                    <div class="card-header bg-danger">
                                        <h4 class="card-title text-white mb-0">Petty Cash Request </h4>
                                    </div>
                                    <div class="card-body">
                                           ...
                                           <div id="datatable-buttons_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer"><div class="row">
                                            ...
                                            <tbody>
                                            <?php foreach($petty as $i){ ?>
                                                <tr>
                                                    <td class="text-center"> <?= $i->category;?></td>
                                                    <td class="text-center"> <?= number_format($i->amount,2);?></td>
                                                    <td class="text-center"> <?= $i->particulars;?></td>
                                                    <td class="text-center"> <?= $i->or_number;?></td>
                                                    ...
                                                    <?php if($this->session->userdata['logged_in']['department'] == 'Sales' && $this->session->userdata['logged_in']['position'] == 'Manager'){?> 
                                                        <?php if( $i->is_status == 1){
                                                            echo $i->manager_approved_date;
                                                        } else { ?>
                                                        <button class="btn btn-outline-dark waves-effect waves-light"  data-bs-toggle="modal" data-bs-target="#approve<?= $i->id;?>"> Approved </button>                       
                                                        <?php } ?>
                                                    <?php  } else { ?>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                                <div class="row">
                                                                                   <img src="<?= base_url();?>/assets/pettycash/<?= $i->location;?>" width="250px;">
                                                                                </div>                                
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-outline-warning waves-effect waves-light"  data-bs-dismiss="modal">Close</button>
                                                                <a href="<?= base_url();?>/assets/pettycash/<?= $i->location;?>" type="button" class="btn btn-outline-dark waves-effect waves-light" download>Download</a>
                                                            </div>
                                                    </div>
                                                </div>
                                                </div>
                                                ...
                                                <div class="modal fade" id="approve<?= $i->id;?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" style="display: none;" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="staticBackdropLabel">Petty Cash Request</h5>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <div class="modal-body">
                                                                            <div class="row">
                                                                                    <div class="col-lg-12">
                                                                                        <form method="POST" action="<?= base_url("pettycash/process-approved-request");?>">
                    ...
                    <div class="modal-body">
                                       <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <form action="<?= base_url("pettycash/process-petty-cash");?>" method="POST"  enctype="multipart/form-data" id="test">
                                                    <input type="hidden" name="csrf_token" id="csrf_token_1" value="<?php echo $this->security->get_csrf_hash(); ?>">

                                                    <div class="mb-3">
                                                        <label for="simpleinput" class="form-label">OR Number </label>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="example-email" class="form-label">Particulars</label>
